...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', default=r'/home/pxshi/files/datasets/mr_us', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--name', type=str, default='maps_CUT2.0', help='name of the experiment. It decides where to store samples and models')
